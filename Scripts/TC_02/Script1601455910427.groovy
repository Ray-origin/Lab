...
'tài khoản không viết hoa và khoảng cách'
WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/input_Username_username (2)'), 'johndoe')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_CURA Healthcare Service/input_Password_password (2)'), 'zPdkBIu2yzwV12AJZZyKxEFzqBOBfWMG')
